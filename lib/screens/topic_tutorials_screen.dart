...
class TopicTutorialsScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TopicTutorialsScreen> createState() =>
      _TopicTutorialsScreenState();
}
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TopicCard(topic: widget.topic, isClickable: false),
                          const SizedBox(height: 32),

                          // Section Title
                          Text(
                            l10n.tutorialsCount(
                              widget.topic.totalTutorials.toString(),
                            ),
                            style: TextStyle(
                              fontSize: 14,
